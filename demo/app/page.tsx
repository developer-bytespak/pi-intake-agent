...
import { useDemoState, type LeadRow, type MatterRow } from "@/app/hooks/useDemoState";
      ...
      <aside className="sidebar" aria-label="Sections">
        <div className="side-brand">
          ...
          <div className="brand-text">
            ...
            <span className="brand-tagline">AI client intake</span>
          </div>
        </div>
        ...
        <div className="side-foot">
          ...
          <button type="button" className="side-reset" onClick={onReset} disabled={resetting} title="Reset demo">
            ...
            <span className="side-reset-hint">Clears the pipeline and the log</span>
          </button>
        </div>
      </aside>
